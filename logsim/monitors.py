...
class Monitors:
    ...
    def __init__(self, names, devices, network):
        ...
        self.error_message = {
            self.NOT_OUTPUT: "Only output pins can be monitored",
            self.MONITOR_PRESENT: "This monitor point is already present",
            self.DEVICE_ABSENT: "monitor point does not exist",
        }
