...
class Network:
    ...
    def __init__(self, names, devices):
        ...
        self.error_message = {
            self.INPUT_TO_INPUT: "Input connected to input",
            self.OUTPUT_TO_OUTPUT: "Output connected to output",
            self.INPUT_CONNECTED: "Input already connected",
            self.INPUT_NOT_CONNECTED: "Specified connection does not exist",
            self.PORT_ABSENT_1: "Specified port does not exist",
            self.PORT_ABSENT_2: "Specified port does not exist",
            self.DEVICE_ABSENT_1: "Specified device does not exist",
            self.DEVICE_ABSENT_2: "Specified device does not exist",
            self.DEVICE_ABSENT_3: "Specified device does not exist",
            self.SWAP_OUTPUTS: "Connections must be swapped from output to output"
        }
