...
class Network:
    ...
    def __init__(self, names, devices):
        ...
        self.error_message = {
            ...
            self.SWAP_OUTPUTS: _(
                "Connections must be swapped from output to output"
            ),
        }
    ...
    def replace_connection(
        ...
        """Change connection from 'first > old' to 'first > new'.
        ...
        if first_device is None:
            ...
            # swapping the input which this output is connected
            # to creates an invalid circuit
    ...
    def execute_gate(self, device_id, x=None, y=None):
        ...
        Note: (x,y) pairs for AND, OR, NOR, NAND, NOT, XOR are: (HIGH, HIGH),
        (LOW, LOW), (LOW, HIGH), (HIGH, LOW), (HIGH, LOW),  (None, None).
