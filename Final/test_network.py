...
def test_check_network(network_with_devices):
    ...
    assert network.check_network() == "Or1.I1 Or1.I2 "
...
def test_replace_connection(network_with_devices):
    """Test if the make_connection function correctly connects devices."""
    network = network_with_devices
    devices = network.devices
    names = devices.names
    ...
    network.replace_connection(OR1_ID, I1, SW2_ID, None, SW1_ID, None)
    network.replace_connection(OR1_ID, I2, SW1_ID, None, SW2_ID, None)

    # or1 inputs should now be connected
    assert or1.inputs == {I2: (SW1_ID, None), I1: (SW2_ID, None)}
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("(I1, I1, OR1_ID, I2)", "network.DEVICE_ABSENT_1"),
        ...
        ("(SW1_ID, I1, OR1_ID, I2)", "network.PORT_ABSENT_1"),
        # Output first
