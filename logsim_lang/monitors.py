...
class Monitors:
    ...
    def __init__(self, names, devices, network):
        ...
        self.error_message = {
            self.NOT_OUTPUT: _("Only output pins can be monitored"),
            self.MONITOR_PRESENT: _("This monitor point is already present"),
            self.DEVICE_ABSENT: _("monitor point does not exist"),
        }
